    ...
    <footer id="contact" class="footer p-10 bg-neutral text-neutral-content">
        ...
        <nav>
            ...
            <div class="grid grid-flow-col gap-4">
                <a class="btn btn-ghost" href="https://github.com/brianpl990227" target="_blank">
                    <IconsGithubBig></IconsGithubBig>
                </a>
                <a class="btn btn-ghost" href="https://www.linkedin.com/in/brian-perez-lopez-2948801a0" target="_blank"><svg
                ...
                <a class="btn btn-ghost" href="https://t.me/+4aZdHLLxia85Njdh" target="_blank"><svg
                        xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                        <path fill="white"
...
<script setup>
import Github from "@/components/icons/GithubBig.vue";
