<template>
    <v-container>
        <h1 class="text-main-color text-center margin-top-10"><strong>Profesional profile</strong></h1>
        <p class="text-center text-main-color">My goals can be summed up in
            one word, professional growth. As
            a software developer I am
            interested in learning from the
            rest of my team and being
            reciprocal, creating a good
            working environment to deliver a
            quality product that more than a
            priority is a necessity in the
            current context. I like to help the rest of my team in tasks where they have difficulties. If I do not know how
